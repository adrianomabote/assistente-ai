      ...
      <div className="bg-white dark:bg-[#202c33] rounded-2xl shadow-2xl p-10 w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="w-full space-y-3">
          ...
          <button
            onClick={submit}
            disabled={loading}
            className="w-full py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors shadow-sm disabled:opacity-70 flex items-center justify-center gap-2"
          >
